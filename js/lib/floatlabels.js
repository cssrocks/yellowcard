        ...
        Plugin.prototype = {
            init: function () {
                ...
                this.$label.css({
                    ...
                    'left'                          : '18px', //thisElement.css('padding-left'),
                    'display'                       : 'none',
                    '-moz-opacity'                  : '0',
                    '-khtml-opacity'                : '0',
                    '-webkit-opacity'               : '0',
                ...
                thisElement.on('blur', function() { thisElement.prev('label').css({ 'color' : '#c4c4c4' }); });
                thisElement.on('focus', function() { thisElement.prev('label').css({ 'color' : '#c4c4c4' }); });
